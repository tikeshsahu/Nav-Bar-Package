// File: lib/src/custom_nav_bar_item.dart
...
class CustomNavBarItem {
  ...
  /// Creates a CustomNavBarItem with either IconData, SVG paths, image paths, or custom widgets
  ///
  ...
  factory CustomNavBarItem.withIcons({
  ...
  factory CustomNavBarItem.withSvg({
    required String title,
  ...
  factory CustomNavBarItem.withImages({
    required String title,
  ...
  factory CustomNavBarItem.withWidgets({
    required String title,
